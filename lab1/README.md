...
2. **Question 2: Palindrome checker**
    ...
    * File: [pallindrome.py](pallindrome.py)
...
9. **Question 9: Temperature Conversion**
    ...
    * File: [tempConversion.py](tempConversion.py)
